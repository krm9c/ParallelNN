...
def test(input_data, target_data, nr_processes, num=15):
    ...
    return sess.run(acc)*100, sess.run(cost)
...
def main():
    ...
    train_acc, cost = test(X_train, y_train, nr_processes)
    print "Training Accuracy:", train_acc, "Cost:", cost
