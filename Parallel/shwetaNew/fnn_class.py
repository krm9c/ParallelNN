...
class learners():
    ...
    def Def_Network(self, classes, Layers, act_function):
    ...
    def init_NN_custom(self, classes, lr, Layers, act_function=tf.nn.relu,
            ...
            with tf.name_scope("PlaceHolders"):  
                ...
                # The main network
                self.Def_Network(classes, Layers, act_function)
