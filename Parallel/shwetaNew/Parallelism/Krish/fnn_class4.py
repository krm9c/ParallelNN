...
class learners():
    ...
    def compute_cost_function(self, act): 
        print "Other Layers Cost Function"
    ...
    def penultimate_cost_function(self, act):
        print "Penultimate Layer Cost Function"
    ...
    def last_cost_function(self):
        print "Last Layer Cost Function"
        ...
        # self.classifier['Local Cost H'] = 10*tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(
    ...
    def W_Custom_Optimizer(self, lr_w):
        train_list = []
        w_update = tf.gradients(self.classifier['Local Cost H'], self.classifier['w_self'])[0]   
        b_update = tf.gradients(self.classifier['Local Cost H'], self.classifier['b_self'])[0]  
