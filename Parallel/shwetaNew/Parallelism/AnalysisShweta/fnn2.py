...
def Z_Training():
    ...
    for s in range(8,10):
        ...
        time_start()
        # Training
        result_file_name = 'z_'+datasetName+'_Layers_7_'+str(s)
        print result_file_name
        print paras_dict
        with open('fnn_Results/'+datasetName+'/'+result_file_name+'.csv', 'wb') as csvfile:
        ...
        np.savetxt('fnn_Results/'+datasetName+'/'+result_file_name+'_weights', weights_update, delimiter=',')
        np.savetxt('fnn_Results/'+datasetName+'/'+result_file_name+'_grads', grads_update, delimiter=',')
        Testing_Accuracy.append(acc_test[j][0]*100)
        Training_Accuracy.append(acc_train[j][0]*100)
        Cost_Progression.append(cost_Total[j][0])
        time_end()
    ...
    # sum3=0
    # for c in Cost_Progression:
    #     sum3=sum3+c
    # cost_avg = sum3/len(Cost_Progression)
    # std_cost = np.std(Cost_Progression)

    # print paras_dict
    # print "\n"
    # print ("Dataset:", datasetName)
    # print ("Avg Cost:", cost_avg, "Std Deviation:", std_cost)
